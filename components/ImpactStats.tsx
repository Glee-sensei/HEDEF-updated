...
const ImpactStats: React.FC = () => {
  // Provided raw image URL for the notebook texture overlay
  ...
  return (
    <section id="impact" className="py-32 md:py-48 bg-slate-950 relative overflow-hidden">
      {/* 
        NOTEBOOK IMAGE OVERLAY BORDERS
        Using the provided image as a decorative texture at the top and bottom.
      */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto mb-24 md:mb-32">
          <div className="inline-flex items-center px-5 py-2 mb-10 bg-white/5 border border-white/10 rounded-full backdrop-blur-2xl shadow-2xl">
            <span className="flex h-2.5 w-2.5 rounded-full bg-red-500 mr-4 animate-pulse"></span>
            <span className="text-white font-black text-[10px] md:text-xs uppercase tracking-[0.4em]">Our Impact Journey</span>
          </div>
          <h2 className="text-4xl md:text-8xl font-serif text-white mb-10 leading-[1.1] tracking-tight">
            Chasing the <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 via-teal-200 to-white">2026 Vision</span>
          </h2>
          <p className="text-lg md:text-2xl text-slate-400 leading-relaxed max-w-2xl mx-auto font-light">
            We are accelerating our operations. Instead of static counts, we are focused on the momentum required to reach these milestones.
          </p>
        </div>
                ...
                <div className="mt-auto pt-10 border-t border-white/5 space-y-8">
                  <div>
                    <div className="flex justify-between items-end mb-5">
                      <span className="text-slate-500 text-[10px] font-bold uppercase tracking-[0.2em]">Active Progress</span>
                      <span className="text-teal-400/60 font-mono text-[9px] uppercase tracking-widest animate-pulse">Scaling Now</span>
                    </div>
                    
                    {/* Visual Progress Bar (without numerical percentage) */}
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="mt-12 text-slate-500 text-[11px] font-black uppercase tracking-[0.5em] text-center opacity-60">
            Every partnership fuels the momentum of our mission
          </p>
        </div>
      </div>
